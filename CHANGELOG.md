...
- Гейт: `tsc --noEmit` ✅, `eslint --max-warnings 0` ✅, vitest полный 1341/1341 + coverage (lines 86.1% ≥ 63) ✅, **Playwright e2e-смоук 28/28 ×2** ✅ (выделенный порт worktree, основное дерево не тронуто).
