...
//! зоны 2–3): статистика базы, недавние заметки, прогресс целей. LLM-виджеты (daily brief / stale
//! radar / …) и кэш-слой — отдельными срезами H2+ (см. `docs/dev/HOME_BACKEND_PLAN.md`).
