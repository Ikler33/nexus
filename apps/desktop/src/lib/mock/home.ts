...
const goals: GoalEntry[] = [
  { path: 'Projects/Orvin.md', title: 'Orvin MVP', progress: 72 },
...
const widgets: Record<string, Widget> = {
  ...
  context_drift: {
    key: 'context_drift',
    content:
      'Заявленный фокус — Orvin MVP, но последние десять правок уходят в инфраструктуру: eval-харнесс, серверные конфиги, перенос дизайна. Цель «Архитектура агентов» не получала записей шесть дней — если это осознанная пауза, зафиксируйте её; иначе фокус размывается.',
    generatedAt: NOW - 3 * H,
    sourceHash: 1,
    status: 'ready',
    stale: false,
