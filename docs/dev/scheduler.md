...
| 7. on-change-триггер | реагировать на правки vault (S4): перезапускать дайджест/противоречия при изменениях (с дебаунсом) | ⏳ |
...
- **Дальше (slice 7):** on-change-триггер (S4) — перезапуск по правкам vault (`vault:changed`) с дебаунсом.
