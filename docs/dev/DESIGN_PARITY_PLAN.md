...
| **DP-14** | статусбар по макету: слева «Синхронизировано» + прогресс/«Проиндексировано · N», справа конфликт-пилюля → resolver, локально/UTF-8/Markdown; убрать путь vault и лейбл темы | DP-13 | ⏳ |
| **DP-15** | `.md`-стрип в табах и дереве (title-first), ★-бейджи избранного в дереве, заголовок секции «ФАЙЛЫ +», перепроверка doc-meta DP-3 | DP-13 | ⏳ |
