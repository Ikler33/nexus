...
- Фронт: `GraphView` — SVG-рендер поверх **`d3-force`** (Граф v2a; sigma.js/graphology убраны).
  ...
  `forceLink` (пружины), `forceCenter` (мягкое центрирование), `forceCollide` (узлы не наезжают).
  ...
  - **Граф v2 (в работе):** v2a физика ✅; дальше — граф-во-вкладку «Граф», пан/зум-камера + авто-fit,
    панель настроек (как в Obsidian ⚙️). Теги-цвета/фильтр — отдельно (нужны теги на узлах).
