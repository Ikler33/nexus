...
- 🔄 **Граф v2** (выбор владельца «полный v2 разом»; отзыв vs Obsidian: мешанина/резкость/градации +
  ...
  - ⏳ **v2b** граф-во-вкладку «Граф» · **v2c** пан/зум-камера + авто-fit · **v2d** панель настроек.
    Делаю серией на той же ветке (или отдельными — по ходу). Камера/вкладка/настройки — следующие.
