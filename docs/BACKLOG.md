...
| ✂️ **Батч + конкурентный эмбеддинг** при первичном скане (сейчас последовательный, по одному чанку) | бенч `bench_index_scale`: **~40 эмб/с → 50k ≈ 21 мин фоном**; bge-m3 принимает батч-вход → рычаг кратного ускорения | при больших vault | `perf.md`, `indexer.md` |
