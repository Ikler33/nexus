# Перекрёстное проектирование: egress · планировщик · vision→AC (DRAFT)
...
> **Статус: DRAFT — ожидает sign-off владельца.** Реализация НЕ начата. Утверждённые ADR переедут в ARCHITECTURE §0.
